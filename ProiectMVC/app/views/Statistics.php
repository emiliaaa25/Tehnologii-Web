...
<body>
    ...
    <div class="section-1">
        ...
        <div class="button-group">
            ...
            <button class="button" onclick="window.location.href='http://localhost/ProiectMVC/app/views/Years.php'"><strong>Years</button>
    ...
    <script>
        ...
        document.getElementById('exportAwards').addEventListener('click', () => {
            window.location.href = 'http://localhost/ProiectMVC/public/index.php?action=exportAwards';
        });
