...
<html lang="ro">
    ...
    <body><!--tarile unde au fost nominalizarile / tabel ani/nominalizari/nominallizatul ales + tabele pe ani + ;-->
        <div class="search-bar" id="searchBar">
            ...
            <button onclick="window.location.href='http://localhost/ProiectMVC/public/index.php?action=statistics&year=0'" class="search-barr"><strong>Statistics</strong></button>
          </div>
        <div class="section-1">
            ...
            <div class="search-container">
                ...
                <button class="button" onclick="window.location.href='http://localhost/ProiectMVC/public/index.php?action=statistics'"><strong>Statistics</strong></button>
