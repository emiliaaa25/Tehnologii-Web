...
<header>
    <div class="search-bar" id="searchBar">
        ...
        <button onclick="window.location.href='http://localhost/ScreenActorAward/public/years'" class="search-barr"><strong>Years</strong></button>
        <button onclick="window.location.href='http://localhost/ScreenActorAward/app/views/StatisticsByYear.php?year=<?php echo $yearRaw; ?>'" class="search-barr"><strong>Statistics</strong></button>
        <?php 
    ...
    <div class="section-1">
        ...
        <div class="button-group">
            ...
            <button class="button" onclick="window.location.href='http://localhost/ScreenActorAward/public/home'">Home Page</button>
            <button class="button" onclick="window.location.href='http://localhost/ScreenActorAward/public/actors'">Actors</button>
            <button class="button" onclick="window.location.href='http://localhost/ScreenActorAward/public/years'"><strong>Years</strong></button>
            <button class="button" onclick="window.location.href='http://localhost/ScreenActorAward/app/views/StatisticsByYear.php?year=<?php echo $yearRaw;?>'"><strong>Statistics</strong></button>
            <?php 
                if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true)
                        ...
                        <?php foreach ($categoryData['nominees'] as $nominee): ?>
                            <li>
                                <?php if ($nominee['name'] === $categoryData['winner']): ?>
                                    <div class="recipient">
                                        <img src="http://localhost/ScreenActorAward/public/pictures/trophy.png" alt="Trophy" class="trophy">
