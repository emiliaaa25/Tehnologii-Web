...
<html lang="ro">
    ...
    <body><!--tarile unde au fost nominalizarile / tabel ani/nominalizari/nominallizatul ales + tabele pe ani + ;-->
        <div class="search-bar" id="searchBar">
            ...
            <button onclick="window.location.href='http://localhost/ScreenActorAward/public/index.php?action=statistics&year=0'" class="search-barr">Statistics</button>
            <?php 
        ...
        <div class="section-1">
            ...
            <div class="search-container">
                ...
                <button class="button" onclick="window.location.href='http://localhost/ScreenActorAward/public/index.php?action=statistics'">Statistics</button>
                <?php 
                if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true)
                ...
                <div class="ani-poze-sec1">
                    ...
                    foreach ($years as $year) {
                        ...
                        if (file_exists($picturePath)) {
                            // The picture exists  2020+-+26th+Annual+Screen+Actors+Guild+Awards
