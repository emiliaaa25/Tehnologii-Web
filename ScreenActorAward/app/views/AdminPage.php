...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true) {
    header('Location: http://localhost/ScreenActorAward/public/login'); // Redirect to the login page
    exit;
}
...
<body>
    ...
    <button onclick="window.location.href='http://localhost/ScreenActorAward/public/index.php?action=logout'" type="submit-login">Logout</button>
