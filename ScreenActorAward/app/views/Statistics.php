...
$genderStatistics = $yearController->getGenderStatistics();

$svg = $yearController->generateBarChart();
$gender_count = [
...
<body>
    ...
    <div class="section-1">
        ...
        <div class="button-group">
            ...
            <button class="button" onclick="window.location.href='http://localhost/ScreenActorAward/public/years'"><strong>Years</button>
            <?php 
                if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true)
    ...
    <div class="chart-container">
        <h2>Gender distribution of nominees</h2>
    ...
    <div class="bar-chart-container">
        <h2>The number of nominees over the years</h2>
        <div>
            <?php echo $svg; ?>
        </div>
    ...
    <div class="user-table">
        <h2 class="legend-text">SCREEN ACTOR GUILD AWARDS</h2>
    ...
    <script>
        ...
        var colors = ["#FFD700", "#8B4513"]; // Gold and Brown colors
        var startAngle = 0;
