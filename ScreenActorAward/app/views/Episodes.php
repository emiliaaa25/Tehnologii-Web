...
<body>
        ...
        <?php foreach ($episode['crew'] ?? [] as $crewMember): ?>
            <div>
                <?php if ($crewMember['profile_path']): ?>
                    <a href="http://localhost/ScreenActorAward/public/actor/<?= isset($crewMember['name']) ? $crewMember['name']: '1' ?>">
    ...
    <div class="member-container">
        <?php foreach ($episode['guest_stars'] ?? [] as $guestStar): ?>
            <div>
                <a href="http://localhost/ScreenActorAward/public/actor/<?= isset($guestStar['name']) ? $guestStar['name'] : '1' ?>">
