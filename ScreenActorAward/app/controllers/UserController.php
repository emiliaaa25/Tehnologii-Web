...
class UserController {
    ...
    public function login() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($this->user->login()) {
                ...
                header('Location: http://localhost/ScreenActorAward/public/admin'); // Redirecționează către pagina de admin
               // echo 'Welcome ' . $_SESSION['name'] . '!';
            } else {
                header('Location: http://localhost/ScreenActorAward/public/login'); // Redirecționează către pagina de admin
            }
        } else {
    ...
    public function deleteUser() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
            ...
            header('Location: http://localhost/ScreenActorAward/public/admin'); // Redirect back to admin page
        }
    }
